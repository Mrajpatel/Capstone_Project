...
<!-- 
    This page is controlled by admin to edit specific tech in the database
...
<div class="container">
    ...
    <div class="">
        <form method="post" action="{{ route('tech.update', [$technologies->id]) }}">
            {{ csrf_field() }}
